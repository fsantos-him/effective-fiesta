...
class AnimationState(Enum):
    ...
    X         = "x"
    X_UP      = "x_up"
    A1        = "a_1" #Zeldris Specific Attack Value. The number marks what phase Zeldris' attack is in
    A2        = "a_2"
    A3        = "a_3"
    B1        = "b_1"
    B2        = "b_2"
...
class CharacterAnimator:
    ...
    def finished(self): #checks if the animation is finished
        frames = self.animations.get(self.current_state) #I noticed the frames are taken from a list so I realized if I wanted to check if an animation was finished, I could use the list
        if not frames: #if there are no frames, then the animation is finished
            return True
        if self.current_frame == (len(frames) - 1): #if the current frame is the same as the last value in the list then return true
            return True
        return False
...
def load_rias_animations(animator):
    ...
    animator.add_animation(AnimationState.IDLE, [
        pygame.Rect(6,   19, 31, 52),
        pygame.Rect(53,  20, 30, 51),
        pygame.Rect(96,  21, 32, 50),
        pygame.Rect(142, 21, 31, 51),
    ], speed=10)

    # RUN (6 frames)
    animator.add_animation(AnimationState.RUN, [
        pygame.Rect(2,   95, 43, 47),
        pygame.Rect(51, 94, 39, 48),
        pygame.Rect(91, 94, 37, 48),
        pygame.Rect(131, 93, 37, 49),
        pygame.Rect(175, 93, 35, 49),
        pygame.Rect(217, 93, 43, 49),
        pygame.Rect(271, 93, 39, 49),
        pygame.Rect(319, 92, 34, 50),
    ], speed=5)
    ...
    animator.add_animation(AnimationState.JUMP, [
        pygame.Rect(13,   186, 28, 42),
        pygame.Rect(52,  174, 51, 54),
        pygame.Rect(104, 174, 51, 54),
        pygame.Rect(158, 180, 59, 48),
        pygame.Rect(223, 153, 46, 75),
        pygame.Rect(284, 153, 43, 75),
        pygame.Rect(336, 186, 42, 42),
        pygame.Rect(384, 194, 32, 34),
        pygame.Rect(422, 186, 28, 42),
    ], speed=10)
...
def load_zeldris_animations(animator):
    ...
    # IDLE (3 frames)
    animator.add_animation(AnimationState.IDLE, [
        pygame.Rect(12, 223, 20, 47),
        pygame.Rect(44, 224, 20, 46),
    ], speed=10)
    ...
    # WALK (8 frames)
    animator.add_animation(AnimationState.WALK, [
        pygame.Rect(14,  290, 19, 46),
        pygame.Rect(39,  290, 21, 46),
        pygame.Rect(68,  290, 22, 46),
        pygame.Rect(98,  290, 18, 46),
    ], speed=5)
    ...
    animator.add_animation(AnimationState.A1, [
        pygame.Rect(12,  633, 28, 44),
        pygame.Rect(48,  635, 38, 43),
        pygame.Rect(98, 635, 39, 43),
    ], speed=7)

    animator.add_animation(AnimationState.A2, [
        pygame.Rect(168,  636, 37, 42),
        pygame.Rect(215,  636, 38, 42),
    ], speed=7)

    animator.add_animation(AnimationState.A3, [
        pygame.Rect(15,  703, 31, 44),
        pygame.Rect(55,  699, 46, 46),
        pygame.Rect(106,  699, 34, 46),
    ], speed=7)
    ...
    animator.add_animation(AnimationState.B1, [
        pygame.Rect(12,765,28,44),
        pygame.Rect(53,766,38,44),
        pygame.Rect(107,766,32,44),
    ], speed=7)

    animator.add_animation(AnimationState.B2, [
        pygame.Rect(164,766,36,44),
        pygame.Rect(207,764,34,44),
        pygame.Rect(259,758,36,50),
        pygame.Rect(310,758,34,50),
    ], speed=7)

    animator.add_animation(AnimationState.B3, [
        pygame.Rect(10,833,36,44),
        pygame.Rect(60,826,65,51),
        pygame.Rect(140,837,63,40),
        pygame.Rect(219,837,39,40),
        pygame.Rect(274,837,34,40),
    ], speed=7)

    animator.add_animation(AnimationState.C1, [
        pygame.Rect(13,902,28,44),
        pygame.Rect(53,904,59,42),
        pygame.Rect(118,904,54,42),
        pygame.Rect(182,904,40,42),
    ], speed=7)

    animator.add_animation(AnimationState.C2, [
        pygame.Rect(16,990,29,57),
        pygame.Rect(63,987,27,60),
        pygame.Rect(113,977,74,70),
        pygame.Rect(209,986,80,88),
        pygame.Rect(310,1006,50,41),
        pygame.Rect(14,1064,45,41),
    ], speed=5)

    animator.add_animation(AnimationState.C3, [
        pygame.Rect(53,904,59,42),
        pygame.Rect(118,904,54,42),
        pygame.Rect(182,904,40,42),
    ], speed=6)
